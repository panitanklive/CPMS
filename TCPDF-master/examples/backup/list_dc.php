...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Ln(5);
        $this->Cell(183, 5, 'รายงานความเสียหายที่ชดใช้แล้ว/ ห้องปฏบัติการเคมี', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Ln();
...
$pdf->SetTitle('รายงานความเสียหายที่ชดใช้แล้ว/ห้องปฏบัติการเคมี');
