...
class MYPDF extends TCPDF {
    ...
    public function Header() {
       ...
       $image_file = K_PATH_IMAGES.'logo_1.jpg';
        ...
        // Title
        $this->Ln(5);
        $this->Cell(183, 5, 'แบบฟอร์มใบคำร้องขอเบิกสารเคมี / ห้องปฏิบัติการเคมี ', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Ln();
...
$pdf->SetTitle('แบบฟอร์มใบคำร้องขอเบิกสารเคมี / ห้องปฏิบัติการเคมี ');
...
function ochem_id(){
	...
	$result = mysqli_query($conn,$query);
		if($result && $result->num_rows>0){ 
			...
			$query = " SELECT a.user_name AS tname, a.user_lastname AS tlastname  FROM tb_ochem b join tb_user a on (b.ochem_teacher = a.user_id) 
			WHERE ochem_id = '$ochem_id'";
			$result = mysqli_query($conn,$query);
			if($result && $result->num_rows>0){ 
			while($row = $result->fetch_assoc()){
...
<head>
	...
	<div><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<b>ใบเบิกสารเคมีเลขที่ : </b>' .$ochem_id.'
	
    <br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<b>ปีการศึกษา :</b> ' .$ochem_year.'<br>
	

	<b>วันที่ยื่นคำร้อง :</b> '.$date.'<br>
	<b>ชื่อ - สกุล ผู้เบิก :</b> '.$user_name.' '  .$user_lastname.'<br>
	<b>กลุ่มเรียน :</b> ' .$user_group.'  / <b>เบอร์ติดต่อ :</b> ' .$user_tel.'<br>
	<b>มีความประสงค์เบิกสารเคมี / วัสดุเพื่อใช้ใน</b> : '.$ochem_object.' <br>
	<b>รายละเอียด</b> : '.$ochem_objectd.'<br>
    ...
    <table border="1" width="100%">
        ...
        <td width="230" bgcolor="#F2F2F2" align="center"><b>ชื่อสารเคมี</b></td>
        <td width="180" bgcolor="#F2F2F2" align="center"><b>สูตร</b></td>
		<td width="80" bgcolor="#F2F2F2" align="center"><b>ปริมาณ</b></td>
 ...
 $html1 .=   fetch_data(); 
 $html1 .=  '</table></div>';
 $html1 .=  '<div>ลงชื่อ .................................................................... อาจารย์ที่ปรึกษางานวิจัย/ผู้รับผิดชอบรายวิชา/เจ้าหน้าที่<br>
			วันที่ .................. เดือน ............................... พ.ศ. .......................<br><br>
			<b>ลงชื่อผู้รับสารเคมี</b>.......................................................&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<b>ลงชื่อผู้จ่ายสารเคมี</b>........................................................<br>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;วันที่ ........................ เวลา ...................
			...
			&nbsp;&nbsp;&nbsp;&nbsp;3. หากมีการอนุมัติจากที่อาจารย์แล้วสารเคมีไม่เพียงพอ ผู้จ่ายสารเคมีจะไม่มีรับผิดชอบหากเกิดกรณีสารเคมีไม่เพียงพอในภายภาคหน้า
			</div>';
