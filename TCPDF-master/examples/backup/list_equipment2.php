...
function fetch_data(){ 
	...
	include("../../myconn/myconn.php");
        $sql=" SELECT oequ_date, oequ_id , user_id , user_name, user_lastname ,equipment_name, oequ_detail_volume2,equipment_unit FROM tb_oequ_detail NATURAL JOIN tb_equipment NATURAL JOIN tb_oequ NATURAL JOIN tb_user 
        where (oequ_status not in('คืนอุปกรณ์ครบแล้ว') )and (oequ_detail_volume2 !=0) and (oequ_detail_return < '$date') ";
  ...
  <tr>
   <td align="center">'.$i.'.</td>
	...
	<td align="center">'.$row["oequ_id"].'</td>
 	...
 	<td align="center">'.$row["oequ_detail_volume2"].'&nbsp;'.$row["equipment_unit"].'</td>
  </tr>';
}
/*$var = 100-$i;
for ($i1=0; $i1 < $var ; $i1++) { 
...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Ln(5);
        $this->Cell(183, 5, 'รายงานอุปกรณ์ทดลองที่ยังไม่ได้ส่งคืน / ห้องปฏบัติการเคมี', 0, false, 'C', 0, '', 0, false, 'M', 'M');
        $this->Ln();
...
$pdf->SetTitle('รายงานอุปกรณ์ทดลองเกินกำหนดคืน/ห้องปฏบัติการเคมี');
...
th{
    ...
    <table border="0" width="100%">
		...
		<th width="80" bgcolor="#F2F2F2" align="center"><b>ยังไม่ได้คืน</b></th>
        </tr>
